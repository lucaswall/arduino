...
const char *MQTT_CLIENTID = "wemos_office01";
const char *OTA_HOSTNAME = "wemos_office01";
const char *deviceId = "office01";
...
DHTSensor dhtSensor(haNetwork, SENSOR_READ_FREQ, D5, DHT21, deviceId, roomName);
